            ...
            <form action="" method="post">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><?php echo isset($value['level']) ? $value['level'] : 'N/A'; ?></td>
                        <td><?php echo isset($value['course']) ? $value['course'] : 'N/A'; ?></td>
                        <td><?php echo isset($value['academicYear']) ? $value['academicYear'] : 'N/A'; ?></td>
                        <td>
